...
def uni_bleu(references, sentence):
    ...
    - references: a list of reference translations, where each
    reference is a list of words - sentence: the proposed
    sentence to be evaluated, represented as a list of words
    """
    ...
    """
     ...
     it calculates the precision using an exponential decay formula that
     considers the ratio of lengths
    """
